...
const introduce = [
  "<span>저</span>는 프론트엔드 웹 개발을 좋아하는 주니어 개발자 입니다. 구현한 결과물을 직관적으로 확인 할 수 있다는 점과 \
개발자의 개성 혹은 성향이 개발 결과물에 비교적 뚜렷하게 반영될 수 있다는 점이 매력적인 장점으로 느껴져 프론트엔드 개발에 흥미를 가지고 공부하고 있습니다. \
대학에서 소프트웨어 공학을 전공하였으며, 졸업 전후로 2년간 블록체인 스마트 컨트랙트 개발 경험이 있습니다. 새로운 기술로써 변화가 빠르고 발전 가능성이 높은 점에 흥미를 느껴 \
블록체인 개발을 시작했지만, 블록체인 플랫폼의 발전 방향에 따른 개발 확장성에 한계를 느껴 개발 분야의 변경을 시도하고 있습니다. \
주로 사용하는 개발 언어는 Javascript . Typescript . Solidity 가 있습니다.",
];
